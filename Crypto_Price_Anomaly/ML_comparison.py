...
def main(args: argparse.Namespace) -> None:
    ...
    eq_base = pd.read_csv(out_dir / "equity_curve.csv", index_col=0, parse_dates=True).iloc[:, 0]
    eq_ml = pd.read_csv(out_dir / "equity_curve_ML.csv", index_col=0, parse_dates=True).iloc[:, 0]
