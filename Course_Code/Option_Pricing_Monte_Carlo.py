...
if __name__ == "__main__":
	...
	print("Call option price with Monte-Carlo approach: %.2f" % model.call_option_simulation()) 
	print("Put option price with Monte-Carlo approach: %.2f" % model.put_option_simulation())
